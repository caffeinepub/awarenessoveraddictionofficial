...
export default function HowToSupportSomeone() {
  const section = educationSections.find(
    (s) => s.slug === "how-to-support-someone",
  )!;
    ...
    <div className="w-full bg-background py-12 md:py-16">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <Alert className="mb-6">
          ...
          <AlertDescription>
            You cannot force someone to change or recover. Your role is to offer
            support, encouragement, and boundaries while they make their own
